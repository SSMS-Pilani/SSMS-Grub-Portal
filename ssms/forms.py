...
class BothForm(forms.ModelForm):
    class Meta:
        model = Both
        fields = ('veg_images', 'non_veg_images', 'veg_price',
                  'non_veg_price', 'veg_venue', 'non_veg_venue')
...
class FeedbackForm(forms.ModelForm):
    quality = forms.CharField(label="Quality", required=False,
                              widget=forms.widgets.TextInput(attrs={}))
    hygiene = forms.CharField(label="Hygiene", required=False,
                              widget=forms.widgets.TextInput(attrs={}))
    ...
    others = forms.CharField(label="Comments", required=False,
                             widget=forms.widgets.TextInput(attrs={}))
