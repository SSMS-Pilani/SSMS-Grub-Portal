...
urlpatterns = [
	...
	url(r'^ssms/coord-active/(?P<cgid>[-\w]+)/$',views.ssms_coord_active,name='coord active'), #register coord
	...
	url(r'^ssms/grub/(?P<gmid>[-\w]+)/spot_signing/$', views.ssms_grub_spot_signing, name='grubs batch'),
 ...
 #Cancel and register for grubs here
	...
	url(r'^menu/$', views.menu_display, name='menu_display'),
	]
