# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-08-30 08:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('veg_venue', models.CharField(choices=[(b'VKB Mess', b'VKB Mess'), (b'KG Mess', b'KG Mess'), (b'RP Mess', b'RP Mess')], max_length=16, verbose_name='Veg Venue')),
                ('non_veg_venue', models.CharField(choices=[(b'VKB Mess', b'VKB Mess'), (b'KG Mess', b'KG Mess'), (b'RP Mess', b'RP Mess')], max_length=16, verbose_name='Non Veg Venue')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('s_id', models.CharField(max_length=32, verbose_name='Bits Id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('n_venue', models.CharField(choices=[(b'VKB Mess', b'VKB Mess'), (b'KG Mess', b'KG Mess'), (b'RP Mess', b'RP Mess')], max_length=16, verbose_name='Non Veg Venue')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('v_venue', models.CharField(choices=[(b'VKB Mess', b'VKB Mess'), (b'KG Mess', b'KG Mess'), (b'RP Mess', b'RP Mess')], max_length=16, verbose_name='Veg Venue')),
        ...
        migrations.AlterUniqueTogether(
            name='grub_student',
            unique_together=set([('s_id', 'gm_id', 'status')]),
        ),
    ]
